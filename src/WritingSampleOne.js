...
function WritingSampleOne() {
  return (
    <div>
    <div>https://3.basecamp.com/3097764/buckets/15434307/messages/2723791851</div>
    <h4>Testing our JavaScript</h4>
    <p> Writing Jest tests for the JavaScript in our Revenue Counter.</p>
    <p>Over the past few weeks, I successfully learned the testing framework Jest and wrote a few tests for our Revenue Counter. While doing this, I found I needed to rewrite some of that JavaScript code in order for the tests to be efficient and effective. It was an awesome process. I learned a lot about testing and a lot about JavaScript. Now we have a few tests in place for the Revenue counter! I'll be writing more tests as time goes now, especially now that it's set up.</p>
...
export default WritingSampleOne;
